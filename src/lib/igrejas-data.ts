...
export const IGREJAS_POR_CIDADE: Record<string, Igreja[]> = {
  "sp/aracatuba": [
    ...
    {
      nome: "Igreja Cristã Maranata — ICM Novo Paraíso",
      denominacao: "evangelica",
      endereco: "Rua Santo Antônio Maria Claret, 416 — Novo Paraíso, Araçatuba/SP",
      lat: -21.196293,
      lng: -50.449133,
    },
    {
      nome: "Igreja do Nazareno",
      denominacao: "evangelica",
      endereco: "Rua Baguaçu, 2060 — Alvorada, Araçatuba/SP, 16016-000",
      lat: -21.228378,
      lng: -50.421329,
    },
    {
      ...
      denominacao: "evangelica",
      endereco: "Rua Gonçalves Ledo, 653 — São Joaquim, Araçatuba/SP, 16050-300",
      lat: -21.202863,
      lng: -50.441379,
    },
    {
